...
<div class="row">
    <div class="col-6">
    <?php 
    // karena static hanya perlu titik 2
    Flasher::flash();
     ?>
    </div>
</div>
...
<div class="input-group ">
  ...
  <div class="input-group-append">
    <button class="btn btn-primary" type="id" id="tombolCari">Cari</button>
  </div>
</div>
</form>
  </div>
...
<div class="row">
    ...
    <ul class="list-group ">
        ...
        <li class="list-group-item ">
            <?php echo $mhs['nama'];  ?>
            <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id'];?>" class='badge badge-danger float-right ml-1' onclick="return confirm('yakin mau ?')">Hapus</a>
